...
IN_PAR(v,double,0.1,%g,Advective velocity)
CHECK_PAR(v>=0)
...
IN_PAR(w0,double,0.9,%g,Concentration of wall bacteria at x=0)
CHECK_PAR(w0>=0)

IN_PAR(uu0,double,0.0,%g,Concentration of free bacteria 2 at x=0)
CHECK_PAR(uu0>=0)

IN_PAR(ww0,double,0.9,%g,Concentration of wall bacteria 2 at x=0)
CHECK_PAR(ww0>=0)

IN_PAR(Si,double,0.9,%g,Initial concentration of Hydrogen)
CHECK_PAR(Si>=0)

IN_PAR(ui,double,0.1,%g,Initial concentration of free bacteria)
CHECK_PAR(ui>=0)

IN_PAR(wi,double,0.9,%g,Initial concentration of wall bacteria)
CHECK_PAR(wi>=0)

IN_PAR(uui,double,0.1,%g,Initial concentration of free bacteria 2)
CHECK_PAR(uui>=0)

IN_PAR(wwi,double,0.9,%g,Initial concentration of wall bacteria 2)
CHECK_PAR(wwi>=0)
