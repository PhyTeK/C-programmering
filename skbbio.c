...
double t241, t242, t243, t244, t245, t246, t247, t248, t249, t250;
      ...
      t152 = t138*t138;
      t155 = t55/t152*t53;
      t158 = t144*t150*(t53*t139-t155);
      t160 = aalpha*C[3]*t53;
      t187 = C[4]*(-t31*t28*t53*t139+t49*t155);
      t189 = aalpha/eepsilon;
      t191 = t189*C[3]*t53;

      BJ[0][0] = ((-t2+t5)*epsilon*C[2]*mw-t10*t12+t10*C[0]*t15-\
      t18*t20+t18*C[0]*t23-t26*t29+t26*t31*t33)*New;
      BJ[0][1] = -New*m*C[0]*t12;
      BJ[0][2] = -epsilon*New*mw*C[0]*t2;
      BJ[0][3] = -New*mm*C[0]*t20;
      BJ[0][4] = -eepsilon*New*t49;
      BJ[1][0] = ((C[2]*t2*t59-t61*t4*t59)*epsilon*mw+C[1]*(m*t12-t68*t15))*New;
      BJ[1][1] = (t74*C[2]+t68*t12-kf-alpha*t78)*New;
      BJ[1][2] = ((t82*t59+t61*t2*t89)*epsilon*mw+t95+epsilon*beta)*New;
      BJ[1][4] = (epsilon*C[2]*mw*t82*t89+t95)*New;
      BJ[2][0] = C[2]*(t2*t55*t57-t5*t58)*mw*New;
      BJ[2][1] = (-t113*t114+t113*t78)*New;
      BJ[2][2] = ((t122+t82*t58)*mw-t127-kw-beta)*New;
      BJ[2][4] = (t122*mw-t127)*New;
      BJ[3][0] = (C[3]*(mm*t20-t134*t23)+t26*t29*t141-t144*C[0]*t33*t141)*New;
      BJ[3][2] = (t158+t160)*New;
      BJ[3][3] = (aalpha*C[2]*t53+t134*t20-kkf-aalpha*t78)*New;
      BJ[3][4] = (eepsilon*mmw*t150*t141+t158+t160+eepsilon*bbeta)*New;
      BJ[4][0] = C[4]*(t29*t140-t31*t33*t55*t139)*New;
      BJ[4][2] = (t187-t191)*New;
      BJ[4][3] = (-t189*t114+t189*(1.0-t77))*New;
      BJ[4][4] = (t31*t28*t55*t139-kkw-bbeta+t187-t191)*New;
}
...
void pr_old_profiles(int MaxIter)
/*=========================*/
{
    int j, i;
